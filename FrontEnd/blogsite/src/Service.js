                        ...
                        <div className="tab-pane fade show active" id="tab-pane-1">
                            <div className="row g-4">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <Link to="/readme" className="btn btn-primary py-3 px-5 mt-3">Read More<i className="fa fa-arrow-right ms-3"></i></Link>                                </div>
                            </div>
                        </div>
                        ...
                        <div className="tab-pane fade" id="tab-pane-4">
                            <div className="row g-4">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <p><i className="fa fa-check text-success me-3"></i>Expert Workers</p>
                                    <p><i className="fa fa-check text-success me-3"></i>Modern Equipment</p>
                                    <Link to="/readme" className="btn btn-primary py-3 px-5 mt-3">Read More<i className="fa fa-arrow-right ms-3"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
